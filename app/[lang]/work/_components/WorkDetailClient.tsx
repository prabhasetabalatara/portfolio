  ...
  return (
    <div className="container mx-auto px-6 py-24 sm:py-32 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <aside className="md:col-span-1">
            <div className="bg-gray-800/50 p-6 rounded-2xl border border-gray-700">
              <h3 className="text-xl font-bold text-white mb-4">{labels.sidebarTitle}</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <User size={18} className="text-cyan-400 mt-1" />
                  <div>
                    <span className="text-sm text-[var(--foreground)]">{labels.roleLabel}</span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-sm text-[var(--foreground)]">{labels.yearLabel}</span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-sm text-[var(--foreground)]">{labels.techLabel}</span>
          ...
          <main className="md:col-span-2">
            <h2 className="text-3xl font-bold text-white mb-4">{labels.aboutTitle}</h2>
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-white mb-6 text-center">{labels.galleryTitle}</h2>
